...
- Crie um repositório no seu GitHub **sem citar nada relacionado**;
...
## Objetivo: PPay Simplificado

O PPay Simplificado é uma plataforma de pagamentos simplificada. Nela é possível depositar e realizar transferências
...
A seguir estão algumas regras de negócio que são importantes para o funcionamento do PPay Simplificado:
